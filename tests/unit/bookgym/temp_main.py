...
class TestGetBookingGoalTime:
    ...
    def test_get_booking_goal_time(self, day, booking_goals, expected_time, expectation):
        with expectation:
...
class TestMain:
    ...
    def test_main(self):
        with patch("requests.Session.post") as m_post, patch("requests.Session.get") as m_get:
