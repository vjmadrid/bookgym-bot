...
class TestBookingService(unittest.TestCase):
    ...
    def test_get_booking_goal_time_with_booking_goals_json_empty(self):
        with pytest.raises(ValueError) as excep:
            BookingService.get_booking_goal_time(
                BookgymDummyDataFactory.TEST_EMPTY_BOOKING_GOALS_JSON,
                BookgymDummyDataFactory.TEST_TARGET_DAY,
            )
    ...
    def test_get_booking_goal_time_with_target_day_null(self):
        with pytest.raises(ValueError) as excep:
            BookingService.get_booking_goal_time(
                BookgymDummyDataFactory.TEST_ONE_DAY_ONE_CLASS_BOOKING_GOALS_JSON, None
            )
    ...
    def test_get_booking_goal_time_with_invalid_target_day(self):
        ...
        result_list = BookingService.get_booking_goal_time(
            BookgymDummyDataFactory.TEST_ONE_DAY_ONE_CLASS_BOOKING_GOALS_JSON,
            BookgymDummyDataFactory.TEST_INVALID_TARGET_DAY,
        )
    ...
    def test_get_booking_goal_time_with_invalid_day_booking_goals_json(self):
        ...
        result_list = BookingService.get_booking_goal_time(
            BookgymDummyDataFactory.TEST_INVALID_DAY_BOOKING_GOALS_JSON,
            BookgymDummyDataFactory.TEST_TARGET_DAY,
        )
    ...
    def test_get_booking_goal_time_with_some_days_one_class_booking_goals_json(self):
        ...
        result_list = BookingService.get_booking_goal_time(
            BookgymDummyDataFactory.TEST_SOME_DAYS_ONE_CLASS_BOOKING_GOALS_JSON,
            BookgymDummyDataFactory.TEST_TARGET_DAY,
        )
    ...
    def test_get_booking_goal_time_with_one_day_some_classes_booking_goals_json(self):
        ...
        result_list = BookingService.get_booking_goal_time(
            BookgymDummyDataFactory.TEST_ONE_DAY_SOME_CLASSES_BOOKING_GOALS_JSON,
            BookgymDummyDataFactory.TEST_TARGET_DAY,
        )
    ...
    def test_get_booking_goal_time_with_some_days_some_classes_booking_goals_json(self):
        ...
        result_list = BookingService.get_booking_goal_time(
            BookgymDummyDataFactory.TEST_SOME_DAYS_SOME_CLASSES_BOOKING_GOALS_JSON,
            BookgymDummyDataFactory.TEST_TARGET_DAY,
        )
